namespace Pnprpg.WebCore
{
	public static class SitePages
	{
		...
		public static string HeroGenIndex => @"/HeroGen/Index";
		public static string HeroGenRace => @"/HeroGen/Race";
		public static string HeroGenResult => @"/HeroGen/Result";
		public static string HeroGenStats_PrimaryGroup => @"HeroGen/Stats/_PrimaryGroup";
		public static string HeroGenStats_SecondaryGroup => @"HeroGen/Stats/_SecondaryGroup";
		public static string HeroGenStatsIncStat => @"/HeroGen/Stats/IncStat";
		public static string HeroGenStatsPrimaryDetails => @"/HeroGen/Stats/PrimaryDetails";
		public static string HeroGenStatsSecondaryDetails => @"/HeroGen/Stats/SecondaryDetails";
		public static string HeroGenTraits => @"/HeroGen/Traits";
		public static string HomeCard => @"/Home/Card";
		public static string Index => @"/Index";
		public static string Magic_Random => @"Magic/_Random";
		public static string MagicIndex => @"/Magic/Index";
		...
		public static string PerksIndex => @"/Perks/Index";
