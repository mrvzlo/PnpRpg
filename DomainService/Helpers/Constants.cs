namespace Pnprpg.DomainService.Helpers
{
    public static class Constants
    {
        ...
        public const int ManualMinAbilityLevel = 8;
        public const int BaseHeroAbilityLevelSum = 40;
        public const int BaseSkillPoints = 3;
        public const int SkillPointsPerLvl = 3;
